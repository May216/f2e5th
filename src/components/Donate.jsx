...
export const Donate = () => {
  return (
    <section id="donate" className=":uno: donate-container">
      <div className=":uno: absolute top-1/2 bg-white rounded-12 p-2rem h-3/5 mx-4 -translate-y-1/2 md:(w-60% left-3.125rem)">
        <div data-aos="flip-left" className=":uno: flex flex-col h-full justify-center items-center">
          ...
          <p className=":uno: text-main text-8 md:text-3.38rem font-bold">$ 987,655,873</p>
